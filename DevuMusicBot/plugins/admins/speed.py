...
from DevuMusicBot.utils import AdminRightsCheck
from DevuMusicBot.utils.database import is_active_chat, is_nonadmin_chat
from DevuMusicBot.utils.decorators.language import languageCB
from DevuMusicBot.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await PubliceMusic.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
