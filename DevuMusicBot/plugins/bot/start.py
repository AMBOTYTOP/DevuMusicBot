...
from DevuMusicBot.utils.decorators.language import LanguageStart
from DevuMusicBot.utils.formatters import get_readable_time
from DevuMusicBot.utils import bot_sys_stats
from DevuMusicBot.utils.inline import help_pannel, private_panel, start_panel
from config import BANNED_USERS, START_IMG_URL
from strings import get_string
from DevuMusicBot.plugins.exambot.stats import get_chats, get_users
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        out = private_panel(_)
        served_chats = len(await get_chats())
        served_users = len(await get_users())
