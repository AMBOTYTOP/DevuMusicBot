...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("DevuMusicBot/assets/font2.ttf", 30)
    font = ImageFont.truetype("DevuMusicBot/assets/font.ttf", 30)
    title_font = ImageFont.truetype("DevuMusicBot/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("DevuMusicBot/assets/play_icons.png")
